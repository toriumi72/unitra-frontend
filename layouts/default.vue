...
<template>
  <div class="fixed bottom-0 left-0 w-full h-auto z-[99]">
    <div class="flex px-3 py-2 items-center shadow bg-white">
      <div class="grow flex items-center">

        <div class="absolute left-1/2 flex items-center justify-center h-14 w-14 -top-6 -translate-x-1/2 rounded-3xl bg-indigo-500 text-white shadow-lg sm:-top-8 sm:h-16 sm:w-16">
  ...
  <div class="bg-white pt-3 pb-20 sm:pt-16 lg:pt-24">
    <slot />
  </div>
</template>
